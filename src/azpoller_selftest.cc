/*  =========================================================================
    azpoller_selftest.c - run selftests
...
all_tests [] = {
    ...
    { "private_classes", azpoller_private_selftest },
...
{
    test_item_t *item;
    printf ("Running azpoller selftests...\n");
    for (item = all_tests; item->test; item++)
        item->test (verbose);
...
main (int argc, char **argv)
{
    ...
    for (argn = 1; argn < argc; argn++) {
        ...
        ||  streq (argv [argn], "-h")) {
            puts ("azpoller_selftest.c [options] ...");
    ...
    if (test) {
        printf ("Running azpoller test '%s'...\n", test->testname);
        test->test (verbose);
    }
    else
        test_runall (verbose);
